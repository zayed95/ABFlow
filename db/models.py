...
from sqlalchemy import String, Integer, Float, DateTime, Enum, ForeignKey, UniqueConstraint, LargeBinary
...
class Experiment(Base):
    ...
    config: Mapped[dict] = mapped_column(JSONB, nullable=False)  # stores MDE, alpha, feature_schema, decision_threshold
